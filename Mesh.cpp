...
Mesh::Mesh()
{
	...
	ZERO_MEM(m_Buffers);
// 	shader = new Shader();
// 	shader->AddShader(GL_VERTEX_SHADER, "./Content/lighting.vs");
// 	shader->AddShader(GL_FRAGMENT_SHADER, "./Content/lighting.fs");
// 	shader->Finalize();
}
...
// 			m_Textures[MaterialIndex]->Bind(GL_TEXTURE0, shader);
// 		}
// 
// 
// 		glBindBuffer(GL_ARRAY_BUFFER, m_Buffers[NORMAL_VB]);
